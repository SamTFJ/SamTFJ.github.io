...
export function HeroContent() {
    return (
        <div className="flex-1 flex flex-col items-center justify-center text-center px-6 pt-12 pb-6 z-20 space-y-4 animate-fade-in delay-200">
            <h1 className="font-heading text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-normal tracking-tight text-card-foreground leading-none transition-colors duration-300">
                Samuel Jales
            </h1>
